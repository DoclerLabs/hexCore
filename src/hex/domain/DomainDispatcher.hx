...
class DomainDispatcher<ListenerType:{}> implements IDomainDispatcher<ListenerType>
{
    ...
    public function addHandler( messageType : MessageType, scope : Dynamic, callback : haxe.Constraints.Function, domain : Domain ) : Bool
    {
        return this.getDomainDispatcher( domain ).addHandler( messageType, scope, callback );
    }

    public function removeHandler( messageType : MessageType, scope : Dynamic, callback : haxe.Constraints.Function, domain : Domain ) : Bool
    {
