...
class PositionTest
{
	...
	{
		var p : Position = new Position( 10.0, 20.0 );
	...
	{
		var p0 = new Position( 45.82, 9.46 );
		var p1 = new Position( 24.67, 67.14 );
	...
	{
		var p0 = new Position( 31.56, 71.69 );
		var p1 = new Position( 91.23, 11.83 );
	...
	{
		var p0 = new Position( 10.0, 20.0 );
		var p1 = new Position( 10.0, 20.0 );
		var p2 = new Position( 10.0, 30.0 );
		var p3 = new Position( 30.0, 20.0 );
