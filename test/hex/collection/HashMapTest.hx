...
class HashMapTest
{
    ...
    public function testPutAndGet() : Void
    {
        ...
        Assert.assertMethodCallThrows( NullPointerException, this._map, this._map.get, [emptyKey], "'get' should throw NullPointerException" );
        Assert.assertMethodCallThrows( NullPointerException, this._map, this._map.get, [null], "'get' should throw NullPointerException" );

        Assert.assertMethodCallThrows( NullPointerException, this._map, this._map.put, [emptyKey, mockValue], "'put' should throw NullPointerException" );
        Assert.assertMethodCallThrows( NullPointerException, this._map, this._map.put, [null, mockValue], "'put' should throw NullPointerException" );

        var emptyValue : MockValueClass = null;
        Assert.assertMethodCallThrows( NullPointerException, this._map, this._map.put, [mockKey, emptyValue], "'put' should throw NullPointerException" );
        Assert.assertMethodCallThrows( NullPointerException, this._map, this._map.put, [mockKey, null], "'put' should throw NullPointerException" );
    }
    ...
    public function testRemove() : Void
    {
        ...
        var emptyKey : MockKeyClass = null;
        Assert.assertMethodCallThrows( NullPointerException, this._map, this._map.remove, [emptyKey], "'remove' should throw NullPointerException" );
        Assert.assertMethodCallThrows( NullPointerException, this._map, this._map.remove, [null], "'remove' should throw NullPointerException" );
    }
    ...
    public function testContainsKey() : Void
    {
        ...
        var emptyKey : MockKeyClass = null;
        Assert.assertMethodCallThrows( NullPointerException, this._map, this._map.containsKey, [emptyKey], "'containsKey' should throw NullPointerException" );
        Assert.assertMethodCallThrows( NullPointerException, this._map, this._map.containsKey, [null], "'containsKey' should throw NullPointerException" );
    }
    ...
    public function testContainsValue() : Void
    {
        ...
        var emptyValue : MockValueClass = null;
        Assert.assertMethodCallThrows( NullPointerException, this._map, this._map.containsValue, [emptyValue], "'containsValue' should throw NullPointerException" );
        Assert.assertMethodCallThrows( NullPointerException, this._map, this._map.containsValue, [null], "'containsValue' should throw NullPointerException" );
    }
